...
def obtener_nombre_vendedor(conn: ServiceLayerConnection, sales_person_code: int) -> str:
        ...
        for linea in lineas:
            ...
            for sn in serial_nums:
                if isinstance(sn, dict):
                    series.append(sn.get('InternalSerialNumber', '') or sn.get('ManufacturerSerialNumber', ''))
...
def calcular_rangos_vencimiento(documentos: List[Dict]) -> Dict:
    ...
    """
    rangos = {
        'USD': {'0_30': 0, '31_60': 0, '61_90': 0, '91_120': 0, 'mas_120': 0, 'total_vencido': 0},
        'CRC': {'0_30': 0, '31_60': 0, '61_90': 0, '91_120': 0, 'mas_120': 0, 'total_vencido': 0},
    }
...
def ejecutar_proceso_cxc():
    ...
    try:
        ...
        for i, cliente in enumerate(clientes, 1):
            ...
            total_docs = len(datos['documentos']['colones']) + len(datos['documentos']['dolares'])
            if total_docs == 0:
